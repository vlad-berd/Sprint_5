...
from data import ExpectedValueConstructorPage as EVCP


class TestConstructorMenuNavigation:
    
    @pytest.mark.parametrize("tab, expected_value", [(Locators.TAB_SAUCES, EVCP.text_tab_sauces), (Locators.TAB_TOPPINGS, EVCP.text_tab_toppings)])
    ...
    def test_navigate_to_breads_section_success(self, driver):
        ...
        is_text_in_element = WebDriverWait(driver, 3).until(EC.text_to_be_present_in_element(Locators.SECTION_SELECTED_CONSTRUCTOR, EVCP.text_tab_breads))
